...
if ( ! class_exists( 'Entertainment_Media_WPTT_WebFont_Loader' ) ) {
	/**
	 * Download webfonts locally.
	 */
	class Entertainment_Media_WPTT_WebFont_Loader {
		 ...
		 * @var string
		 */
		protected $entertainment_media_css;
...
if ( ! function_exists( 'wptt_get_webfont_styles' ) ) {
	...
	function wptt_get_webfont_styles( $url, $format = 'woff2' ) {
		$font = new Entertainment_Media_WPTT_WebFont_Loader( $url );
